      ...
      >
        <Calendar
          ...
          classNames={{
            ...
            nav_button: cn(
              "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 text-white cursor-pointer"
            ),
            ...
            cell: "h-9 w-9 text-center relative hover:bg-white/10 rounded-md cursor-pointer",
            day: cn(
              "h-9 w-9 p-0 font-normal text-white hover:bg-white/20 rounded-md cursor-pointer select-none"
            ),
            day_selected: "bg-white/20 text-white hover:bg-white/30 focus:bg-white/30",
